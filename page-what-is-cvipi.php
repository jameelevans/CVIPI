	...
	<div class="cvipi__container">
			...
			<div class="our-story__container">
				<div class="our-story__content">
					<header class="our-story__header">
						...
						<h2 class="our-story__heading">Launched in <em>FY 2022</em></h2>
					</header>
						...
						if ( have_posts() ) :
							while ( have_posts() ) :
								...
								if ( '' !== trim( get_the_content() ) ) {
									...
									?>
									<p>CVIPI launched in FY 2022 as a historic federal investment in community violence intervention, aimed at preventing and reducing violent crime through comprehensive, evidence-based community programs.</p>
									<p>Several DOJ components collaborate on the initiative—BJA, NIJ, OJJDP, and OVC—to ensure jurisdictions have access to expertise and resources for addressing community violence.</p>
									<p>This initiative builds partnerships among community residents, local government, law enforcement, hospitals, victim service providers, community-based organizations,researchers, and other stakeholders to <a href="#">help prevent and reduce violent crime in our communities</a>.</p>
									<?php
								}
							endwhile;
						else :
		...
		<section class="we-serve">
			...
			<div class="we-serve__details">
				...
				<div class="we-serve__stats">
					<span class="we-serve__number">$300<em>M</em></span>
					<p class="we-serve__number-details">Federal Investment</p>
				</div>
				<div class="we-serve__stats">
					<span class="we-serve__number">40</span>
					<p class="we-serve__number-details">Grantees</p>
				</div>
			</div>
